...
let loadingCount = 0;           //纪录当前有几个ajax没有结束
...
export default function(userOptions) {
        ...
        loadingCount++;
        loadingInstance = Loading.service({ text: "loading...",spinner:"el-icon-loading" });                 //开启loading效果
                        ...
                        if(response.status === 200) {
                                switch(response.data.status) {
                                        ...
                                        case 401:
                                                ...
                                                await MessageBox.alert("登录超时，请重新懂了! ","提示",{type:"warning"}.showClose=false);
